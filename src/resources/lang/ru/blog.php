...
return [
    ...
    'category' => [
        ...
        'popup' => [
            ...
            'title-deactivate' => 'Отключение',
            'title-activate' => 'Включение',
            ...
            'activate-status' => 'Включено',
            'deactivate-status' => 'Выключено',
            'activated-text' => 'Категория была включена',
            'deactivated-text' => 'Категория была выключена'
        ],
    ],
